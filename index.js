...
const BASE_URL = 'https://api.exohood.com'

class ExohoodAPI {
  /**
   *
   * @param {Object=} Options Options for the ExohoodAPI instance
   *
   ...
   * @param {Object=} options for the request consistent to https://api.exohood.com/#tag/Tickers
   * @param coinId: string
  ...
  getAllTickers (params = {}) {
    ...
    if ((historical && typeof coinId === 'undefined') || (coinId && historical && typeof historical.start === 'undefined')) {
      throw Error('required param was not pass, please check ExohoodAPI client usage')
    }
  ...
  /**
   * Get a list of all cryptocurrencies available on exohood.com.
   *
   * @example
   * const client = new ExohoodAPI()
